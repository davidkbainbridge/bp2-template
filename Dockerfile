...
ENV BP_HOOK_URL_REDIRECT_PEER_UPDATE=http://127.0.0.1:6789/api/v1/hook/peer-status
ENV BP_HOOK_URL_REDIRECT_PEER_STATUS=http://127.0.0.1:6789/api/v1/hook/peer-update
